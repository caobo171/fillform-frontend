                ...
                <>
                    <div className=" bg-white" style={{ width: 320 }}>
                        <div className="flex flex-col items-center justify-center">
                            <div className="text-center text-lg text-gray-400 mb-2 mt-2">Bạn đã đạt được huy hiệu</div>
                            {
                                show && (
                            ...
                            {
                                !show && <div style={{ height: 160, width: 160 }} className="p-3 rounded-lg bg-red-100 flex items-center justify-center">
                            ...
                            <div className="text-center text-lg text-gray-400 mt-1">Xin chúc mừng</div>
